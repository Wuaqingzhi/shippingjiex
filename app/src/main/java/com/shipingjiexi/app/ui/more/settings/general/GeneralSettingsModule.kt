package com.shipingjiexi.app.ui.more.settings.general
...
import com.shipingjiexi.app.databinding.NavOptionsItemBinding
import com.shipingjiexi.app.ui.adapter.IconsSheetAdapter
import com.shipingjiexi.app.ui.adapter.NavBarOptionsAdapter
import com.shipingjiexi.app.ui.more.settings.SettingHost
                ...
                (pref as SwitchPreferenceCompat).apply {
                    setOnPreferenceChangeListener { pref, _ ->
                        ...
                        val aliasComponentName =
                            ComponentName(context, "com.shipingjiexi.app.terminalShareAlias")
            ...
            "show_quick_download_share" -> {
                (pref as SwitchPreferenceCompat).apply {
                    setOnPreferenceChangeListener { pref, _ ->
                        val packageManager = context.packageManager
                        val aliasComponentName =
                            ComponentName(context, "com.shipingjiexi.app.quickDownloadShareAlias")
                        if ((pref as SwitchPreferenceCompat).isChecked){
                            packageManager.setComponentEnabledSetting(aliasComponentName,
                                PackageManager.COMPONENT_ENABLED_STATE_DISABLED,
                                PackageManager.DONT_KILL_APP)
